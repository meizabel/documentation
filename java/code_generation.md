...
We generate these Throwable classes because Java does not support generic types for throwables. More on this read in [Working with Business Failures](/java/defining_business_failures).
