...
**Note:** If the passed dispatcher deals with commands, for which another dispatcher have already registered the dispatch entries, for such commands will not be unregistered, and warning will be logged.
